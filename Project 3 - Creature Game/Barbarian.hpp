...
/*
 Description: This class is an abstraction that represents a Barbarian Creature. It will be a subclass of the base Creature class. It will inherit all member data and member functions from the Creature class. The only independent functionality this class will have is a default constructor, an attack function, a defense function, and a special ability function all specific to the Barbarian class. These functions will override the parent functions in the Creature class. Objects of this class are to be used when a player elects to use the Barbarian creature in the simulated fight game.
 */
