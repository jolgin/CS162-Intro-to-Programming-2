...
/*
 Description: This function will print a menu for the user to choose an option from. Currently, the user can only choose to start or end the program. The function does not take any arguments, and it will return an integer that represents the user's choice. The function will also validate input.  
*/
...
int menuFunction()
{
    ...
    cout << "Please choose the number of the option you want from below: " << endl << endl;
    cout << "\t" << "1.  Start Program" << endl;
    cout << "\t" << "2.  Exit Program" << endl;
    
    cin >> userOption;
    
    while((userOption != 1 && userOption !=2) || !userOption)
    {
