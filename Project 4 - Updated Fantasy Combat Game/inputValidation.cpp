...
/*
 Description: This function will validate the size of the teams the user selects. It will force the user to enter an integer between 3 and 10, inclusive. It will take an integer argument that represent the user's initial entry for the size. It will return an integer representing the user's final selection that has been validated.
 */
int teamSizeValidation(int size)
{
    while(!cin || size > 10 || size < 3)
    {
        cout << "Invalid input. Please enter an integer for the team size (At least 3 but less than 10): " << endl;
        cin.clear();
        cin.ignore();
...
/*
 Description: This function will validate the user's entry for the nick name of the creature they selected. It will force the user to enter a string that is 20 or less characters. It will take an integer argument representing their initial entry. It will return an integer representing their final validated entry.
 */
